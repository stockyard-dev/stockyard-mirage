...
<main>
  <div class="hero">
    <h1>Mirage</h1>
    <p>API mock server — define endpoints and response shapes, serve fake JSON instantly</p>
  </div>
  <div class="stats">
    <div class="stat">
  ...
  <div class="card">
    ...
    <div class="tier-box">
      <div class="tier">
        ...
        <div class="tier-desc">10 endpoints, 500 logged requests</div>
        <div class="tier-price">$0/mo</div>
      </div>
      <div class="tier pro">
        <div class="tier-name">Pro</div>
        <div class="tier-desc">Unlimited endpoints and logs</div>
